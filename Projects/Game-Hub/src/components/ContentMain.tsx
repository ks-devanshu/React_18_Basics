...
function ContentMain() {
    ...
    <div className="mx-3 md:mx-10 my-5 text-2xl w-full">
        <h1 className="text-5xl md:text-8xl font-bold dark:text-white">Games</h1>
        ...
        <div className="hidden md:block mt-10 relative">
            ...
            { platformDDV && <div className="bg-mist-100 w-60 rounded-xl border absolute left-0" onMouseEnter={() => setPlatformDDV(true)} onMouseLeave={() => setPlatformDDV(false)}>
                <ul>
            ...
            {orderByDDV && <div className="bg-mist-100 w-60 rounded-xl border absolute left-38" onMouseLeave={() => setOrderByDDV(false)} onMouseEnter={() => setOrderByDDV(true)}>
                <ul>
        ...
        {genres.map((genre) => <div key={genre} className="pt-2 px-2 items-center w-40 h-40 lg:w-80 lg:h-80 border flex flex-col rounded-xl mt-5 dark:bg-gray-200">
            ...
            <div className="max-h-20 lg:max-h-40 flex flex-col grow-1 justify-evenly">
                ...
                <a className="border border-none w-30 lg:w-60 rounded-xl bg-gray-800 text-white hover:bg-gray-600 py-1"><span className="text-base my-0 mx-5 max-w-20 lg:max-w-40 lg:mx-20">Exlpore 🢅</span></a>
            </div>
        </div>)}
        </div>
